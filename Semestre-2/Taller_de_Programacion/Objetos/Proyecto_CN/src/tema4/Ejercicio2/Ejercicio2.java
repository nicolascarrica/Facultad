...
public class Ejercicio2 {
    public static void main(String[] args) {
        Jugador miJugador = new Jugador("Bochini", 2000, 15, 500, 300);
        Entrenador miEntrenador = new Entrenador ("Bianchi", 3000, 10, 12);
        
        System.out.println(miEntrenador.ToString());
